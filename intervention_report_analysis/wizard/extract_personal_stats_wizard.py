...
"""class AcountAnalyticAccount(orm.Model):
    ''' Model name: Account 
    '''    
    ...
    def action_print(self, cr, uid, ids, context=None):
        ...
        excel_pool.write_xls_line(WS_name, table_start_row, [
            ...
            excel_pool.format_hour(total_user['contract'][1], float_time, 
                zero_value=' '),
            excel_pool.format_hour(total_user['open'][0], float_time, 
                zero_value=' '),
            excel_pool.format_hour(total_user['open'][1], float_time, 
                zero_value=' '),
            excel_pool.format_hour(total_user['fixed'][0], float_time, 
                zero_value=' '),
            excel_pool.format_hour(total_user['fixed'][1], float_time, 
                zero_value=' '),
            excel_pool.format_hour(total_user['unfixed'][0], float_time, 
                zero_value=' '),
            excel_pool.format_hour(total_user['unfixed'][1], float_time, 
                zero_value=' '),
            excel_pool.format_hour(total_user['internal'][0], float_time, 
                zero_value=' '),
