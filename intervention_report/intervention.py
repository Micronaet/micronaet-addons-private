...
class hr_analytic_timesheet_extra(osv.osv):
    ...
    _columns={
        ...
        'intervention_request': fields.text('Intervention request', help = "Keep track of the origina request"),
        'intervention': fields.text('Intervention description', help = "All description of the intervent, used for print report"),
        'internal_note': fields.text('Internal note', help = "Note for save some impression, no comunication to customer"),        
